...
png(file="plot2.png", height=480, width=480, bg="transparent", type="cairo")
  plot(posix_datetime, data$Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)")
dev.off()
