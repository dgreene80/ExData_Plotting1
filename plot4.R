...
png(file="plot4.png", height=480, width=480, bg="transparent", type="cairo")
  par(mfrow = c(2, 2))
    plot(posix_datetime, data$Global_active_power, type="l", xlab="", ylab="Global Active Power")
    plot(posix_datetime, data$Voltage, type="l", xlab="datetime", ylab="Voltage")
    ...
    plot(posix_datetime, data$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()
